...
return [
  ...
  'active_url' => 'Поље :attribute мора бити важец́а УРЛ адреса.',
  ...
  'email' => 'Поље :attribute мора бити важец́а емаил адреса.',
  'ends_with' => 'Поље :attribute мора да се завршава са једним од следец́их: :values.',
  ...
  'in' => 'Изабрани :attribute је неважец́и.',
  ...
  [
    ...
    'atLeastOneLocation' => 
    [
      'required' => 'Барем једна опција (онлине или уживо) мора бити одабрана.',
    ],
  ],
];

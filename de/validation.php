...
return [
  ...
  'array' => 'Das Feld :attribute muss eine Aufstellung sein.',
  'ascii' => 'Das Feld :attribute darf nur Zeichen mit einem Byte (Buchstaben, Zahlen und bestimmte Symbole) enthalten.',
  ...
  'between' => 
  [
    'array' => 'Das Feld :attribute darf zwischen :min und :max Zeichen haben.',
    'file' => 'Das Feld :attribute darf zwischen :min und :max Kilobyte groß sein.',
    'numeric' => 'Das Feld :attribute darf zwischen :min und :max liegen.',
    'string' => 'Das Feld :attribute darf zwischen :min und :max Zeichen haben.',
  ],
  ...
  'digits_between' => 'Das Feld :attribute darf zwischen :min und :max Ziffern haben.',
  'dimensions' => 'Das Feld :attribute hat ungültige Bildabmessungen.',
  'distinct' => 'Das Feld :attribute hat einen doppelten Wert.',
  'doesnt_end_with' => 'Das Feld :attribute darf nicht mit einem der folgenden Felder enden: :values.',
  'doesnt_start_with' => 'Das Feld :attribute darf nicht mit einem der folgenden Werte beginnen: :values.',
  'email' => 'Das Feld :attribute muss eine gültige E-Mail-Adresse sein.',
  'ends_with' => 'Das Feld :attribute muss mit einem der folgenden Felder enden: :values.',
  ...
  'filled' => 'Das Feld :attribute Feld muss einen Wert haben.',
  'gt' => 
  [
  ...
  [
    ...
    'file' => 'Das Feld :attribute muss mindestens :value Kilobyte sein.',
  ...
  'lt' => 
  [
    'array' => 'Das Feld :attribute Feld muss weniger als :value Elemente enthalten.',
    'file' => 'Das Feld :attribute muss kleiner als :value Kilobyte groß sein.',
  ...
  [
    ...
    'file' => 'Das :attribute darf höchstens :max Kilobyte groß sein.',
  ...
  'missing_if' => 'Das Feld :attribute Feld muss fehlen, wenn :other :value ist.',
  ...
  [
    ...
    'symbols' => 'Das Feld :attribute Feld muss mindestens ein Symbol enthalten.',
    'uncompromised' => 'Das angegebene Feld :attribute ist in einem Datenleck aufgetaucht. Bitte wählen Sie ein anderes :attribute aus.',
  ],
  ...
  'prohibited_unless' => 'Das Feld :attribute Feld ist verboten, es sei denn, :other ist in :values enthalten.',
  ...
  'required_without_all' => 'Das Feld :attribute ist erforderlich, wenn keins der :values vorhanden ist.',
  ...
  [
    'avatar' => 
    [
      'base64image' => 'Die Datei muss ein gültiges Bild sein (jpeg, png, jpg, gif, svg).',
    ],
    'atLeastOneRole' => 
    [
